...
TRANSLATIONS = {
    ...
    "nav_radar": {"en": "Radar", "fr": "Radar"},
    "nav_fidelity": {"en": "Fidelity", "fr": "Fidélité"},
    "nav_stability": {"en": "Stability", "fr": "Stabilité"},
    "nav_per_dataset": {"en": "Per Dataset", "fr": "Par Dataset"},
    "nav_decision": {"en": "Decision", "fr": "Cadre Décisionnel"},
    "nav_benchmark": {"en": "Benchmark", "fr": "Benchmark en Direct"},
    "nav_method": {"en": "Methods", "fr": "Détails des Méthodes"},
